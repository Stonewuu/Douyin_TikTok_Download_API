...
> 🔀**This warehouse Fork from[Evil0ctal/Douyin_TikTok_Download_API](https://github.com/Evil0ctal/Douyin_TikTok_Download_API)**, thank the original author for his open source contribution!

### ✨ New feature: API Cookie Override

This fork version adds**API Cookie Override**Feature that allows custom cookies to be passed in API requests, overriding`config.yaml`the default configuration in .
...
-   Multiple account concurrent requests
-   Dynamically switch cookies without restarting the service
-   Isolate cookie configuration by request level
